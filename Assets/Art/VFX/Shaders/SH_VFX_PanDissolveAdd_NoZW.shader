	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 uv3_GradientShape = IN.ase_texcoord4.zw * _GradientShape_ST.xy + _GradientShape_ST.zw;
				...
				float2 uv3_DissolveDirection = IN.ase_texcoord4.zw * _DissolveDirection_ST.xy + _DissolveDirection_ST.zw;
				...
				float2 uv3_ColorTexture = IN.ase_texcoord4.zw * _ColorTexture_ST.xy + _ColorTexture_ST.zw;
				...
				float2 uv3_Texture = IN.ase_texcoord4.zw * _Texture_ST.xy + _Texture_ST.zw;
...
ASEEND*/
//CHKSM=3F977FE50A85BAE4FBB9DC6D21A0F79401979934