	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 uv2s4sampler_DissolveMask = IN.ase_texcoord5;
				uv2s4sampler_DissolveMask.xy = IN.ase_texcoord5.xy * sampler_DissolveMask_ST.xy + sampler_DissolveMask_ST.zw;
...
ASEEND*/
//CHKSM=8E41B5438BC866582FC433E5CF1B817463CAB6E7