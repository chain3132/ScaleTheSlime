	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 uv2_GradientShape = IN.ase_texcoord5.xy * _GradientShape_ST.xy + _GradientShape_ST.zw;
				...
				float4 uvs4_DistortMask = IN.ase_texcoord4;
				uvs4_DistortMask.xy = IN.ase_texcoord4.xy * _DistortMask_ST.xy + _DistortMask_ST.zw;
				...
				float2 uv2_DissolveDirection = IN.ase_texcoord5.xy * _DissolveDirection_ST.xy + _DissolveDirection_ST.zw;
				...
				float2 uv2_ColorTexture = IN.ase_texcoord5.xy * _ColorTexture_ST.xy + _ColorTexture_ST.zw;
				...
				float2 uv2_Texture = IN.ase_texcoord5.xy * _Texture_ST.xy + _Texture_ST.zw;
...
ASEEND*/
//CHKSM=5284CEB49925ADBCB54669A55D097290A16547B1